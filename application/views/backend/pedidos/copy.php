      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form class="form" name="form_registrar_pedido" id="form_registrar_pedido" method="post" action="/backend/pedidos/new">
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <?php if ($pedido->requiere_oc): ?>
                    <div class="col-xs-12 col-md-4 form-group">
                      <label for="requiere_oc">Orden de compra <span class="badge" data-toggle="tooltip" title="Este pedido no podrá ser facturado hasta no asignarle una orden de compra">?</span></label>
                      <input type="text" class="form-control" placeholder="Orden de compra" name="requiere_oc" id="requiere_oc" value="<?= $pedido->oc ?>">
                    </div>
                  <?php endif ?>
