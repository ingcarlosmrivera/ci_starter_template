        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-users"></i> Editar Servicio</h3>
            </div>
            
            <form class="form" name="form_editar_servicio" id="form_editar_servicio" method="post">
              <div class="box-body">
                <div class="row">
                  <div class="col-xs-12 form-group">
                    <label for="servicio">Servicio</label>
                    <input type="hidden" name="idservicio" id="idservicio" value="<?= $servicio->idservicio ?>">
                    <input type="text" class="form-control" placeholder="Razón social" name="servicio" id="servicio" value="<?= $servicio->servicio ?>">
                  </div>

                  <div class="col-xs-12 col-md-6 form-group">
                    <label for="cuit">Código</label>
                    <input type="text" class="form-control" placeholder="Código" name="codigo" id="codigo" value="<?= $servicio->codigo ?>">
                  </div>
                  ...
                  <div class="col-xs-12 col-md-6 form-group">
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" value="1" name="is_medical" id="is_medical" <?= ($servicio->is_medical) ? "checked='checked'" : '' ?>>
                      </label>
                    </div>
                  </div>
              ...
              <div class="box-footer text-right">
                ...
                <button type="submit" class="btn btn-success btn-flat">Editar Servicio</button>
              </div>
            </form>
      ...
      submitHandler(form) {
        ...
        .done(function(data) {
          ...
          if (data.status == 'success') {
            $('#form_editar_servicio').trigger("reset");
